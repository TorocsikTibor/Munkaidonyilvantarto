...
Route::get('/makeproject', [\App\Http\Controllers\ProjectController::class, 'makeProject']);
...
Route::get('/admin/project/{project}', [\App\Http\Controllers\AdminController::class, 'editProject'])->middleware('can:admin');
Route::post('/admin/project/{project}', [\App\Http\Controllers\AdminController::class, 'updateProject'])->middleware('can:admin');
Route::delete('/admin/project/{project}', [\App\Http\Controllers\AdminController::class, 'deleteProject'])->middleware('can:admin');
